...
#end make Tana_m.f90
 fpm clean
#fpm build --flag  "-fopenmp $QMLDIR/libpot.a $ADDIR/libAD_dnSVM.a"
#fpm build --flag  "-fopenmp -lpot -lAD_dnSVM -L$QMLDIR -L$ADDIR"
fpm build --link-flag  "-fopenmp -lpot -lAD_dnSVM -L$QMLDIR -L$ADDIR"



gfortran -v -fopenmp -o TI_Schrod.x  -L$QMLDIR -L$ADDIR $FPMDIR/app_TI_Schrod.f90.o -lpot -lAD_dnSVM -lblas -llapack

exit
gfortran -fopenmp -o TI_Schrod.x  $FPMDIR/app_TI_Schrod.f90.o -lpot -lAD_dnSVM -L$QMLDIR -L$ADDIR -lblas -llapack

gfortran -v -fopenmp -o TI_Schrod.x  $FPMDIR/app_TI_Schrod.f90.o $FPMDIR/libTI_Schrod.a $QMLDIR/libpot.a $ADDIR/libAD_dnSVM.a -lblas -llapack
...
./TI_Schrod.x < DAT_files/Dat_test_QML_op6_37clh2p > 8_37ClH2p_QML_op6
